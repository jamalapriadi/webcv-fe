        ...
        <div class="page-body">
            <div class="container-xl">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div v-if="loadingPermission" class="text-center">
...
export default {
    ...
    validate({ params, query, store }) {
        ...
        {
            if(store.$auth.user.data.permissions[a].name == "set_role_permission")
            {
                return true
            }
        }
    ...
    methods:{
        ...
        getData(){
            ...
            this.$axios.get('/auth/role/'+this.kode)
                .then(resp => {
        ...
        savePermission(){
            ...
            this.$axios.post('/auth/set-role-permission/'+this.kode, this.selected)
                .then(resp => {
