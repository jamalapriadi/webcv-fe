                        ...
                        <table class="table" v-if="list_fields.length > 0">
                            ...
                            <tbody>
                                <tr v-for="(l,idx) in list_fields" :key="idx">
                                    ...
                                    <td>{{l.type}}</td>
                                    <td>
                                        <a href="#" class="btn btn-danger w-100" @click.prevent="deleteList(idx)">
...
export default {
    ...
    validate({ params, query, store }) {
        ...
        {
            if(store.$auth.user.data.permissions[a].name == "edit_section")
            {
                return true
            }
        }
    ...
    methods:{
        ...mapActions('section',['save','change_handle_switch','change_path_image','addFields','show']),
        ...
        getData(){
            ...
            this.show(id)
                .then(()=>{
                    this.list_fields = this.nmodel.fields
                })
        },
