<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-7">
                <div class="form-group">
                    <label for="" class="form-label">Website Client</label>
        ...
        <div class="text-end">
            <a v-if="kode == 'Y'" href="#" @click.prevent="simpan" class="btn btn-info">Add Client</a>
            <a v-if="kode != 'Y'" href="#" @click.prevent="update" class="btn btn-info">Update Client</a>
        </div>
...
export default{
    ...
    data(){
        return {
            ...
            json_fields:{
                title:this.title == '' ? this.title : 'Clients' ,
