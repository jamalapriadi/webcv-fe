        ...
        <div class="card mt-2" v-if="form">
            <div class="card-header" style="background:white;border:none">
                <strong>
                    ...
                    {{ $bahasa.showLabel({label:'Pencapaian',negara:form.bahasa}) }}
                </strong>
            </div>
            <div class="card-body" v-if="form.pencapaian">
                <div class="divide-y" v-if="form.pencapaian.length > 0">
                    <div v-for="(l,idx) in form.pencapaian" :key="idx">
                        <div class="row mb-3">
                            <div class="col">
                ...
                <hr class="mt-4" v-if="form.pencapaian.length > 0">
                ...
                <a href="#" class="btn btn-outline-secondary btn-block mt-3" @click.prevent="addTambahan">
                    ...
                    {{ $bahasa.showLabel({label:'Tambah Pencapaian lain',negara:form.bahasa}) }}
                </a>
            </div>
        </div>
    </div>
