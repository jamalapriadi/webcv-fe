        ...
        <div class="card" style="border:none">
            <div class="card-body" style="border:none">
                ...
                <div class="row mt-1">
                    <div class="col-3">
                        <div>
                            <h3 style="border-bottom:1px solid lightgray; padding-bottom:10px;">Personal Info</h3>
                            <p class="mt-1">
                        ...
                        <div class="mt-1" v-if="person.keahlian && person.keahlian.data.length > 0">
                            <h3 style="border-bottom:1px solid lightgray; padding-bottom:10px;">Skills</h3>
                        ...
                        <div class="mt-1" v-if="person.bahasa && person.bahasa.data.length > 0">
                            <h3 style="border-bottom:1px solid lightgray; padding-bottom:10px;">Languages</h3>
