export const state = () => ({
    ...
    addLink: '/category/create',
    btnAction:true,
    edit_data_form: '/category',
    backBtn:'/category',
    lists:[],
    list:{},
    meta:{
...
export const actions = {
    async get_data({commit, state}){
        ...
        const res = await this.$repositories.category.perPage(params)
    ...
    async save({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.category.save(payload)
    ...
    async show({commit,state}, id){
        ...
        const res = await this.$repositories.category.show(id)
    ...
    async update({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.category.update(payload.kode, payload)
