export const state = () => ({
    ...
    fields:[
        ...
        {key:'kode_negara', label:'Kode Negara', sortable:false},
        {key:'nama_negara', label:'Nama Negara', sortable:false},
        {key: 'actions',label:'', sortable: false, thStyle:{width:'15%'}}, 
    ],
    addLink: '/negara/create',
    btnAction:true,
    edit_data_form: '/negara',
    backBtn:'/negara',
    lists:[],
    list:{},
    meta:{
...
export const actions = {
    async get_data({commit, state}){
        ...
        const res = await this.$repositories.negara.perPage(params)
    ...
    async save({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.negara.save(payload)
    ...
    async show({commit,state}, id){
        ...
        const res = await this.$repositories.negara.show(id)
    ...
    async update({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.negara.update(payload.kode, payload)
