...
export const mutations = {
    ...
    SET_ROLES(state,data){
        ...
        for(var a=0;a<state.forms.length; a++)
        {
            if(state.forms[a].model == "role")
            {
                state.forms[a].list = data
            }
        }
    },
...
export const actions = {
    ...
    async searchData({commit, dispatch}, val)
    {
        commit('SET_FILTER_DATA', val)
        dispatch('get_data')
    }
