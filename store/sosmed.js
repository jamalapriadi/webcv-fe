export const state = () => ({
    ...
    addLink: '/sosmed/create',
    btnAction:true,
    edit_data_form: '/sosmed',
    backBtn:'/sosmed',
    lists:[],
    list:{},
    meta:{
...
export const actions = {
    async get_data({commit, state}){
        ...
        const res = await this.$repositories.sosmed.perPage(params)
    ...
    async save({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.sosmed.save(payload)
    ...
    async show({commit,state}, id){
        ...
        const res = await this.$repositories.sosmed.show(id)
    ...
    async update({commit, state}, payload){
        ...
        try{
            const res = await this.$repositories.sosmed.update(payload.kode, payload)
